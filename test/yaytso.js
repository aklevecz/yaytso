...
contract("Testing yaytso V2", async (accounts) => {
    ...
    it("creates egg, creator is owner", async () => {
        const dag =
            "bafkreihvjgtp2vmeyebct3jixc2vga6dzdzycovmwsvqso2ftssxtj4sny";
    ...
    it("makes a pb", async () => {
        const pbUri =
            "bafkreihvjgtp2vmeyebct3jixc2vga6dzdzycovmwsvqso2ftssxtj4sny";
        const patternHash =
            "0x2b072aad9c073438fadcdb82976f826e22b988f4105baadd330b0a0d4e5eec9c";
        const resp = await instance.layYaytso(accounts[0], patternHash, pbUri);
      const tokenId = getTokenId(resp)
      console.log(tokenId)
    });
});
